...
REPORT_COLUMNS = {
    ...
    "target_title": {"sqlite": "VARCHAR(120) DEFAULT 'JD-Based Analysis'", "postgresql": "VARCHAR(120) DEFAULT 'JD-Based Analysis'"},
    "job_description": {"sqlite": "TEXT DEFAULT ''", "postgresql": "TEXT DEFAULT ''"},
    "jd_requirements": {"sqlite": "JSON DEFAULT '{}'", "postgresql": "JSON DEFAULT '{}'::json"},
